...
wget.callbacks.get_urls = function(file, url, is_css, iri)
  ...
  if string.match(url, "^https?://[^/]*coursera%.org/") and string.match(url, "[^a-zA-Z]"..item_value) and not string.match(url, "[^a-zA-Z]"..item_value.."[a-zA-Z]") then
    ...
    if string.match(url, "forum_id=[0-9]+") then
      ...
      check("https://class.coursera.org/"..classname.."/api/forum/forums/"..forum_id.."/threads?sort=lastupdated&page=1&page_size=25")
      check("https://class.coursera.org/"..classname.."/api/forum/forums/"..forum_id.."/threads?sort=subscribed")
      check("https://class.coursera.org/"..classname.."/api/forum/forums/"..forum_id.."/threads?sort=lastupdated")
      check("https://class.coursera.org/"..classname.."/api/forum/forums/"..forum_id.."/threads?sort=null")
    end
    if string.match(url, "thread_id=[0-9]+") then
      ...
      check("https://class.coursera.org/"..classname.."/forum/thread?thread_id="..thread_id.."&sort=oldest")
      check("https://class.coursera.org/"..classname.."/api/forum/threads/"..thread_id.."?sort=oldest")
      check("https://class.coursera.org/"..classname.."/forum/thread?thread_id="..thread_id.."&sort=newest")
      check("https://class.coursera.org/"..classname.."/api/forum/threads/"..thread_id.."?sort=newest")
      check("https://class.coursera.org/"..classname.."/forum/thread?thread_id="..thread_id.."&sort=popular")
      check("https://class.coursera.org/"..classname.."/api/forum/threads/"..thread_id.."?sort=popular")
    end
